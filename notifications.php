...
if($user_ok != true || $log_username == ""){
	header("location: http://www.dostinow.com");
    exit();
}
$notification_list = "";
...
if($numrows < 1){
	...
	while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
		...
		if($user1avatar == NULL){
			$user1pic = '<img src="avatardefault.jpg" alt="'.$user1.'" class="user_pic">';
		}
...
<style type="text/css">
div#notesBox{float:left; width:430px; border:#F0F ; margin-right:60px; padding:10px;}
div#friendReqBox{float:left; width:430px; border:#F0F ; padding:10px;}
